...
$tempCreateUrl = $accountUrl . "appId=" . $baseUrlParam . "&key=" . $random . "&userId=" . Yii::$app->user->identity->getId() . "&lang=" . MessageTemplate::getMessageTempateLang(Yii::$app->language) . '&theme=' . $themeColor . "&action=" . $action;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <!--  <div class="col-md-6">
                                      <div class="form-group">
                                          <label for="FormMembershipType_twMessage"></?php /*echo $attributeLabels['twMessage']; */?></label>
                                          </?php  /*echo $form->field($model, 'twMessage')->textarea(array('rows' => 4, 'cols' => 50, 'id' => 'twMessage', 'label' => false, 'class' => 'form-control mceNoEditor'))->label(false); */?>
                                          <div class="form-feild-info"><span id="twCountDown"></span></div>
                                      </div>
                                  </div>-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <?php if (!$model->isInstant) { ?>
                                        ...
                                        <div class="form-actions">
                                            <?php
                                            echo Html::submitButton($model->isNewRecord ? Yii::t('messages', 'Create') : Yii::t('messages', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary'])
                                            ?>

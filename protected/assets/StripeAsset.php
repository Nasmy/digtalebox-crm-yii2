...
class StripeAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        'themes/bootstrap_spacelab/stripe/css/base.css',
        'themes/bootstrap_spacelab/stripe/css/style.css',
    ];
    public $js = [
        ...
        'themes/bootstrap_spacelab/stripe/js/index.js',
        'themes/bootstrap_spacelab/stripe/js/script.js',

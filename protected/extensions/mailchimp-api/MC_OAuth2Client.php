...
namespace Mailchimp;
use MailchimpOAuth\OAuth2Client;
use MailchimpOAuth\OAuth2Exception;
...
class MC_OAuth2Client extends OAuth2Client
{
     ...
     public function __construct($clientId = null, $clientSecret = null, $redirectUri = null,$session = null ) {
         ...
         $path = '/testing/mailchimp/complete.php'; //the path on your host

         $client_id = null === $clientId ? '681784952478' : $clientId;   //client_id from creating app in MC (see README)
         $client_secret = null === $clientSecret ? 'e5730e72ffe678569ccaea0b0ad4f9ea' : $clientSecret; //client_secret from creating app in MC  (see README)
         ...
         /*if(!is_null($session)){
             ...
             $config = array_merge($config,$session);
         } */
     ...
     public function refreshToken(){
        ...
        if(!$data['access_token']){
                     throw new OAuth2Exception( array('Invalid Session, please re-authorize your account') );
        }

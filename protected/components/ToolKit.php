...
class ToolKit extends Component
{
    ...
    public function getSystemFeatureList()
    {
        $featureList = array(
            ...
            // Dashboard
            array(
                'mmName' => 'main', 'id' => 'dash', 'image' => 'dashboard.jpg',
            ...
            // People
            array(
                'mmName' => 'main', 'id' => 'people', 'image' => 'people.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'basic_srch', 'image' => 'basic-search.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'advanced_srch', 'image' => 'advncd-srch.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'user_match', 'image' => 'matching.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'saved_srch', 'image' => 'saved-srch.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'keywords', 'image' => 'keywords.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'bulk_insert', 'image' => 'bulk-upload.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'teams', 'image' => 'teams.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'social_activity', 'image' => 'social-activity.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'volunteers', 'image' => 'Volunteers.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'events', 'image' => 'events.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'resource', 'image' => 'Resource.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'activity', 'image' => 'Activities.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'donation', 'image' => 'donation.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'friend_find', 'image' => 'friend-find.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'petition', 'image' => 'petition.jpg',
            ...
            array(
                'mmName' => 'people', 'id' => 'membership', 'image' => 'membership.jpg',
            ...
            // Communication
            array(
                'mmName' => 'main', 'id' => 'communication', 'image' => 'communication.jpg',
                ...
                'freemium' => array('show', 'disable'), 'cm' => array('show'), 'showTip' => false, 'title' => Yii::t('messages', 'Communication'), 'link' => Html::a(
                    Yii::t('messages', 'See more about Communication..'),
                    '#',
                    array('id' => 'communicationMore')
                )
            ),
            array(
                'mmName' => 'communication', 'id' => 'msg-template', 'image' => 'msg-templates.jpg',
            ...
            array(
                'mmName' => 'communication', 'id' => 'newCampaign', 'image' => 'new-campaigns.jpg',
            ...
            array(
                'mmName' => 'communication', 'id' => 'campaigns', 'image' => 'sent-campaigns.jpg',
            ...
            array(
                'mmName' => 'communication', 'id' => 'msg-box', 'image' => 'message-box.jpg',
            ...
            // System
            array(
                'mmName' => 'main', 'id' => 'system', 'image' => 'system.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'mng-roles', 'image' => 'manage-roles.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'mng-sys-users', 'image' => 'managFe-sys-users.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'org-info', 'image' => 'org-info.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'ad-banner', 'image' => 'ad-banner.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'feed-keywords', 'image' => 'feed-keywords.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'config', 'image' => 'configuration.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'portal-settings', 'image' => 'portal-settings.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'custom-fields', 'image' => 'custom-fields.jpg',
            ...
            array(
                'mmName' => 'system', 'id' => 'form-builder', 'image' => 'form-builder.jpg',
            ...
            // Site Guide
            array(
                'mmName' => 'main', 'id' => 'site_guide', 'image' => 'home.jpg',
            ...
            // Invite
            array(
                'mmName' => 'main', 'id' => 'invite', 'image' => 'invite.jpg',
            ...
            // Account
            array(
                'mmName' => 'main', 'id' => 'account', 'image' => 'account.jpg',
            ...
            array(
                'mmName' => 'account', 'id' => 'my-account', 'image' => 'my-account.jpg',
            ...
            array(
                'mmName' => 'account', 'id' => 'chng-pass', 'image' => 'change-pass.jpg',
            ...
            array(
                'mmName' => 'account', 'id' => 'lang', 'image' => 'language.jpg',
            ...
            array(
                'mmName' => 'account', 'id' => 'Logout', 'image' => 'logout.jpg',
...
JS;
    ...
    public function changeDbConnectionWeb()
    {
        ...
        if (isset($apps[$domain])) {
            return $this->changeDbConnection(
                $apps[$domain]['dbName'],
                $apps[$domain]['host'],
    ...
    public function sendModeratorEmails($message, $otherEmails = array(), $subject = "DigitaleBox")
    {
        ...
        $message = Yii::$app->controller->renderPartial(
            '@app/views/emailTemplates/notificationTemplate',
            ['content' => $message],
            true
        );

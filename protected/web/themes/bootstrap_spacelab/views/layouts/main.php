...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo Yii::$app->toolKit->getImagePath() ?>apple-touch-icon.png">
    ...
    <div class="frame">
        ...
        <div class="app-header">
            <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                ...
                <a class="navbar-brand" href="<?php echo Yii::$app->urlManager->createUrl('dashboard/dashboard') ?>">
                    <img src="<?php echo Yii::$app->toolKit->getImagePath() ?>digitalebox-logo@2x.png">
                </a>
                <button class="navbar-toggler" type="button" data-toggle="collapse"
                        data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                        aria-expanded="false" aria-label="Toggle navigation">
                    <div class="pic"><img src="<?php echo Yii::$app->toolKit->getImagePath() ?>user-profile.png"></div>
                </button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown header-dropdown desktop-hide">
                            <a class="nav-link"
                               href="<?php echo Yii::$app->urlManager->createUrl('User/ChangePassword') ?>"
                        ...
                        <li class="nav-item dropdown languages header-dropdown">
                            <a class="nav-link" href="#" title="Language" id="navbarDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="text desktop-hide"><?php echo Yii::t('messages', 'Languages') ?></div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <?php foreach (Yii::$app->params['lang'] as $key => $langInfo): ?>
                                    <a class="dropdown-item list-items <?php echo $key == Yii::$app->language ? "active" : ""; ?>"
                                       href="<?php echo Yii::$app->urlManager->createUrl('Site/ChangeLang',
                        ...
                        <li class="nav-item dropdown header-dropdown">
                            <!--for mobile-->
                            <a class="nav-link desktop-hide"
                               href="<?php echo Yii::$app->urlManager->createUrl('msg-box/inbox'); ?>"
                               title="Messages" id="navbarDropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">
                            ...
                            <!--for desktop-->
                            <a class="nav-link mobile-hide" href="#" title="Messages" id="navbarDropdown"
                            ...
                            <div class="dropdown-menu dropdown-menu-right mobile-hide" aria-labelledby="navbarDropdown">
                                ...
                                if (null != $msgBoxModels):
                                    foreach ($msgBoxModels as $msgBoxModel): ?>
                                        <a class="dropdown-item messages list-items"
                                           href="<?php echo Yii::$app->urlManager->createUrl('msg-box/view-inbox-msg',
                                            ...
                                            <div class="date"><?php echo $feed->getTimeElapsed($msgBoxModel["dateTime"]); ?></div>
                                        </a>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                                <?php if (App::getNewMessageCount() > App::NOTIFICATION_MESSAGE_COUNT): ?>
                                    <a class="dropdown-item messages list-items see-all"
                                       href="<?php echo Yii::$app->urlManager->createUrl('msg-box/inbox') ?>">
                        ...
                        <li class="nav-item dropdown header-dropdown mobile-hide">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item user-profile"
                                   href="<?php echo Yii::$app->urlManager->createUrl('user/my-account') ?>">
                                    <div class="pic"><?php echo User::getPic(null, 30, 30, "", Yii::$app->user->id) ?></div>
                                    <div class="details">
                                        <div class="name"><?php // echo implode(' ', array(Yii::$app->user->firstName, Yii::$app->user->lastName)) ?></div>
                                ...
                                <a class="dropdown-item"
                                   href="<?php echo Yii::$app->urlManager->createUrl('user/my-account') ?>"><i
                                            class="fa fa-user fa-lg"></i>
                                    <?php echo Yii::t('messages', 'My Account') ?></a>
                                <a class="dropdown-item"
                                   href="<?php echo Yii::$app->urlManager->createUrl('user/change-password') ?>"><i
                                            class="fa fa-lock fa-lg"></i>
                                    <?php echo Yii::t('messages', 'Change Password') ?></a>
                                <a class="dropdown-item"
                                   href="<?php echo Yii::$app->urlManager->createUrl('site/logout') ?>"><i
                                            class="fa fa-power-off fa-lg"></i> <?php echo Yii::t('messages', 'Logout') ?>
                                </a>
                            </div>
                        </li>

...
class Campaign extends \yii\db\ActiveRecord
{
    ...
    {
        $smsOneCount = strlen($messageTemplate->smsMessage);
        $smsTwoCount = strlen($messageTemplate->smsMessageTwo);
        $messageList = [];
        $totalSmsChaCount = $smsOneCount + $smsTwoCount;
        if ($totalSmsChaCount <= MessageTemplate::MSG_LEN_SMS ) {
            $smsMessage = $messageTemplate->smsMessage . " " . $messageTemplate->smsMessageTwo;
            $messageList = [$smsMessage];
        } else {
            $messageList = (!empty($messageTemplate->smsMessageTwo)) ? [$messageTemplate->smsMessage, $messageTemplate->smsMessageTwo] : [$messageTemplate->smsMessage];
        }

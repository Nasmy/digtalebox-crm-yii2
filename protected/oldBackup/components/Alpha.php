...
class Alpha extends Validator
{
    ...
    public function validateAttribute($object, $attribute)
    {
        ...
        $message = $this->message ? $this->message : Yii::t('alpha', '{attribute} contains not allowed characters',['attribute'=>$attribute]);
     ...
     */
    public function clientValidateAttribute($object, $attribute, $view=null)
    {
        // get the pattern
        $pattern = $this->elaboratePattern();
        // get the error message
        $message = $this->message ? str_replace('{attribute}', $attribute, $this->message) : Yii::t('alpha', '{attribute} contains not allowed characters', ['attribute'=>$attribute]);

...
use app\models\App;
/**
 * Class m210509_092941_campaign_sms_status
 */
class m210509_092941_campaign_sms_status extends Migration
{
    ...
    public function up()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $table = Yii::$app->db->schema->getTableSchema('CampaignUsers');
                    if(!isset($table->columns['smsStatus'])) {
                        $this->alterColumn('CampaignUsers', 'smsStatus', $this->tinyInteger(1)->null()->defaultValue(NULL));
                    }
    ...
    public function down()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->alterColumn('CampaignUsers', 'smsStatus', $this->tinyInteger(1)->notNull()->defaultValue('NONE'));

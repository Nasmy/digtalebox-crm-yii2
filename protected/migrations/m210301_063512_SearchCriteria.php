...
/**
 * Class m210301_063512_SearchCriteria
 */
class m210301_063512_SearchCriteria extends Migration
{
    ...
    public function up()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->alterColumn('SearchCriteria', 'userType', $this->tinyInteger(2)->null()->defaultValue(NULL)->comment('	Type of user. 1 - Politician 2 - Supporter 3 - Prospects 4 - Non support'));
    ...
    public function down()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->alterColumn('SearchCriteria', 'userType', $this->tinyInteger(2)->notNull()->defaultValue('NONE')->comment('	Type of user. 1 - Politician 2 - Supporter 3 - Prospects 4 - Non support'));

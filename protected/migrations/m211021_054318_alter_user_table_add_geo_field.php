...
/**
 * Class m211021_054318_alter_user_table_add_geo_field
 */
class m211021_054318_alter_user_table_add_geo_field extends Migration
{
    ...
    public function up()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->addColumn('User', 'geoPoint', 'point AFTER `longLat` ');
                } catch (Exception $e) {

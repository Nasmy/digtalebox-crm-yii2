...
/**
 * Class m211213_172154_add_column_to_MessageTemplate_smsMessageTwo
 */
class m211213_172154_add_column_to_MessageTemplate_smsMessageTwo extends Migration
{
    ...
    public function up()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->addColumn('MessageTemplate', 'smsMessageTwo', 'varchar(200) AFTER `smsMessage` ');
                } catch (Exception $e) {

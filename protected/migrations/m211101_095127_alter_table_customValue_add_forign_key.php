...
/**
 * Class m211101_095127_alter_table_customValue_add_forign_key
 */
class m211101_095127_alter_table_customValue_add_forign_key extends Migration
{
    ...
    public function up()
    {
        ...
        if (null != $appModels) {
            ...
            foreach ($appModels as $appModel) {
                ...
                try {
                    $this->addForeignKey('FK_CustomValue_Field_ID', 'CustomValue', 'customFieldId','CustomField', 'id');
                    $this->addForeignKey('FK_CustomValue_User_ID', 'CustomValue', 'relatedId','User', 'id');
                } catch (Exception $e) {
